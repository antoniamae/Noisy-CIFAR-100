...
wandb.init(project="cifar100-noisy", name="experiment29")
...
df.to_csv("kaggle\\working\\submission29.csv", index=False)

wandb.save("kaggle\\working\\submission29.csv")
