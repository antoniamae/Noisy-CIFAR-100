...
wandb.init(project="cifar100-noisy", name="experiment46_1")
...
df.to_csv("kaggle\\working\\submission46_1.csv", index=False)

wandb.save("kaggle\\working\\submission46_1.csv")
