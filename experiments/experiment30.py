...
wandb.init(project="cifar100-noisy", name="experiment34")
...
val_loader = DataLoader(test_dataset, batch_size=128, shuffle=False, pin_memory=pin_memory)
...
df.to_csv("kaggle\\working\\submission34.csv", index=False)

wandb.save("kaggle\\working\\submission34.csv")
