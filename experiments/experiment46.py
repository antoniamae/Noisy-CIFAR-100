...
wandb.init(project="cifar100-noisy", name="experiment50")
...
model = timm.create_model('efficientnet_b0', pretrained=True, num_classes=100, drop_rate=0.3)
...
df.to_csv("kaggle\\working\\submission50.csv", index=False)

wandb.save("kaggle\\working\\submission50.csv")
