...
wandb.init(project="cifar100-noisy", name="resnet18_cifar10_e7")
...
df.to_csv("kaggle\\working\\submission7.csv", index=False)

wandb.save("kaggle\\working\\submission7.csv")
# %%