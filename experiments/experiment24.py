# 22 - lr(rn), wd(rn, m), epochs changed
import torch
...
wandb.init(project="cifar100-noisy", name="experiment28")
...
df.to_csv("kaggle\\working\\submission28.csv", index=False)

wandb.save("kaggle\\working\\submission28.csv")
