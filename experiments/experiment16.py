...
wandb.init(project="cifar100-noisy", name="experiment18")
...
def train():
    ...
    for inputs, targets in train_loader:
        ...
        weights = mentor_scores / (mentor_scores.sum() + 1e-6)
...
df.to_csv("kaggle\\working\\submission18.csv", index=False)

wandb.save("kaggle\\working\\submission18.csv")
