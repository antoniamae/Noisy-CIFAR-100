...
wandb.init(project="cifar100-noisy", name="experiment40")
...
mentor_net.train()
for epoch in range(15):  # Pretraining loop
...
df.to_csv("kaggle\\working\\submission40.csv", index=False)

wandb.save("kaggle\\working\\submission40.csv")
