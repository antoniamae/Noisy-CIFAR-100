...
wandb.init(project="cifar100-noisy", name="experiment19")
...
df.to_csv("kaggle\\working\\submission19.csv", index=False)

wandb.save("kaggle\\working\\submission19.csv")
