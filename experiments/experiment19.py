...
wandb.init(project="cifar100-noisy", name="experiment21")
...
model = timm.create_model('wide_resnet50_2', pretrained=True, num_classes=100, drop_rate=0.3)
...
df.to_csv("kaggle\\working\\submission21.csv", index=False)

wandb.save("kaggle\\working\\submission21.csv")
