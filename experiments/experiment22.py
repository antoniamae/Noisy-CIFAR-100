...
wandb.init(project="cifar100-noisy", name="experiment25")
...
val_loader = DataLoader(val_dataset, batch_size=300, shuffle=False, pin_memory=pin_memory)
...
df.to_csv("kaggle\\working\\submission25.csv", index=False)

wandb.save("kaggle\\working\\submission25.csv")
