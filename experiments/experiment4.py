...
wandb.init(project="cifar100-noisy", name="resnet50_1_training")
...
train_set = SimpleCachedDataset(train_set, train_transforms, False)
...
df.to_csv("kaggle\\working\\submission3.csv", index=False)

wandb.save("kaggle\\working\\submission3.csv")
# %%
