...
wandb.init(project="cifar100-noisy", name="experiment33")
...
df.to_csv("kaggle\\working\\submission33.csv", index=False)

wandb.save("kaggle\\working\\submission33.csv")
